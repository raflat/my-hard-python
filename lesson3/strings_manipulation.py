...
# listo direttamente i metodi anche se non è necessario impararli a memoria
# ma è prezioso sapere che esistono



##################################################

# Escaping: usando il carattere \ si possono escapare certi caratteri speciali.
...
# indexing: le stringhe possono essere pensate come delle speciali liste di caratteri.
# Possiamo quindi accedere ad un singolo carattere usando:
txt = "yellow"
print(txt[0]) # è "y"
...
# separandola (splittandola) per spazio o una porzione di testo fornita
...
# una cosa importante che si può fare in python su ogni elemento indicizzato
# (quindi le stringhe, ma anche le liste in generale) è lo slicing.

# anziché fornire un indice (che tral'altro vanno anche al contrario,
# quindi -1 è l'ultimo elemento) si fornisce un intervallo di indici nella forma [start:step:stop]
# questo crea delle fettine (da cui, slicing).
# Per semplicità ignoriamo il valore step (che di default è 1),
# e consideriamo start come il primo indice che farà parte della fetta
...
# Se start non viene specificato si parte dal primo indice disponibile,
# se stop non viene definito si considera l'ultimo indice +1 (così da darci l'ultimo elemento)
# quindi [:3] fornisce una slice contenente i primi tre elementi,
# [3:] fornisce una slice che va dal terzo elemento fino al fondo
