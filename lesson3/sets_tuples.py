...
# Per completezza, parliamo brevemente di altre due strutture dati
# che fanno parte delle "collections": sets e tuple
...
type(my_set)
print(my_set)
if "qualcosa" in my_set:
    print("Present")

# ma NON possiamo accedere direttamente ad un elemento di un set,
# essendo questi non indicizzati né ordinati.
...
# essendo immutabili non è possibile aggiungere o rimuovere elementi,
# e dispongono solo di due metodi: https://www.programiz.com/python-programming/methods/tuple


#####################################

# Con questo abbiamo introdotto tutte le strutture dati più utili in Python.
# A questo link trovate un utile raffronto fra liste, sets, tuple e dizionari:
# https://www.educative.io/answers/list-vs-tuple-vs-set-vs-dictionary-in-python
# in ogni caso liste e dizionari sono i più usati
# mentre in certi casi i set risultano particolarmente utili.
# Le tuple sono per usi molto specifici.
